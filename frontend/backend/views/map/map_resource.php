...
<script src="/content/js/uncommon/map_resource.js" type="text/javascript"></script>
...
<div id="MapInfoCon" class="pull-left">
    ...
    <div id="MapInfoNav">
        ...
        <textarea id="dataSource" style="display: none;"><?php if(!empty($resultData['mapData'])) {echo html::encode(json_encode($resultData['mapData']['listMapInformation']));} ?></textarea>
...
<?php if(!empty($resultData['mapData'])){//组织架构
