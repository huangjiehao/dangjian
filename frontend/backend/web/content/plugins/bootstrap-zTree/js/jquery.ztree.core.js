    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeIcon: function (html, setting, node) {
                ...
                if(str != null){
                    ...
                    for(var i=0; i<dataSource1.length; i++){
                        if(index == i+1) {
                            html.push("data-address='", dataSource1[i]['address'], "' " +
                                "data-lat='", dataSource1[i]['latitude'], "' " +
                                "data-lng='", dataSource1[i]['longitude'], "' " +
                                "data-name='", dataSource1[i]['title'], "' " +
                                "data-id='", dataSource1[i]['id'], "' data-full='", dataSource1[i]['fullName'], "'");
                        }
                    }
                }
            ...
            makeDOMNodeMainBefore: function (html, setting, node) {
                html.push("<li id='", node.tId, "' class='", consts.className.LEVEL, node.level, " bg' tabindex='0' hidefocus='true' treenode>");
            },
