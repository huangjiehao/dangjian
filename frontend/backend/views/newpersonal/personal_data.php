            ...
            <div class="form-box fr loginV2"  style="display:block;">
                ...
                <div class="form-con">
                    <div class="login-normal" style="display:block;">
                        <form class="form-horizontal" id="loginForm"   method="post" action="/personal/personal_data_submit"><!--id="nameLoginForm Personal_data_submit"-->
                            ...
                            <dl class="top1 clearfix">
                                <dt>身份证号码：</dt>
                                <dd><input type="text" name="idCard" class="input-text" autocomplete="off" value=""  placeholder="请输入身份证号码"></dd>
                            </dl>
                            <dl class="top1 clearfix">
                                <dt>角色：</dt>
                                <dd>
                                    <input type="hidden" name="userRoleIds" id="userRoleIds"
                                           value="<?php if (!empty($data['data'])) {
                                               echo html::encode($data['data']['userRoleIds']);
                                           } ?>">
                                    <select id="selUserRoleIds" type="text" class="form-control select_picker"
                                            multiple="multiple">
                                        <?php
                                        if (!empty($userdata['roles'])) {
                                            foreach ($userdata['roles'] as $i => $item) {
                                                echo '<option value="' . html::encode($item['idStr']) . '"> ' . html::encode($item['name']) . '</option>';
                                            }
                                        }
                            ...
                            <dl class="top1 clearfix">
                                <dt>账号：</dt>
                                <dd><input type="text" name="loginName" class="input-text" autocomplete="off" value=""  placeholder="请输入账号"></dd>
                            </dl>
                            <!--<dl class="top1 clearfix">
                                <dt>密码：</dt>
                                <dd><input type="password" name="password" class="input-text pwd" autocomplete="off" value=""  placeholder="请输入密码"></dd>
                            </dl>-->
                            <div class="btn-box clearfix">
                                <input id="submitBtn" class="btn-settlement submit_btn" type="submit" value="保    存" >
                            </div>
                        </form>
...
<script>
    $(document).ready(function () {
        ...
        $('.submit_btn').click(function () {
            if ($('#selUserRoleIds').selectpicker('val')) {
                $('#userRoleIds').val($('#selUserRoleIds').selectpicker('val').join(','));
            }
        });
    });
</script>
<style>
    .bootstrap-select.btn-group .dropdown-toggle .filter-option{ color:#222;}
    .btn-group>.btn:first-child:not(:last-child):not(.dropdown-toggle), .btn-group .btn+.btn, .btn-group .btn+.btn-group, .btn-group .btn-group+.btn, .btn-group .btn-group+.btn-group{ color:#222;}
    .form-control{ margin-top: -8px; height: 38px; line-height: 38px; box-shadow:inset 0 0 0 rgba(0,0,0,.075);-webkit-box-shadow:inset 0 0 0 rgba(0,0,0,.075);}
    input[type='text'], input[type='number'], input[type='password'], input[type='reset'], input[type='tel'], textarea{
        border:0;
    }
    .bs-searchbox{ margin-top: 5px;}
    .btn-group .btn+.btn, .btn-group .btn+.btn-group, .btn-group .btn-group+.btn, .btn-group .btn-group+.btn-group{
        margin-left: 0;
    }
    .btn-group>.btn:first-child:not(:last-child):not(.dropdown-toggle),
    .btn-group .btn+.btn, .btn-group .btn+.btn-group, .btn-group .btn-group+.btn, .btn-group .btn-group+.btn-group{ border:1px solid #ddd;}
    ...
    .login-wrap .form-box{ width:480px; margin: 15px 0 40px 0; background:#fff; border-top-left-radius: 5px; border-top-right-radius: 5px;}
    .form-box .form-tab{ width:480px; height:52px; border-bottom:1px solid #ddd; margin-bottom:8px;font-family:"Microsoft YaHei";}
    .form-tab .tab-li{ float:left; width:100%; height:50px; border-bottom:2px solid #fff;}
    .form-tab .tab-li a{ position:relative; display:block; border-top-left-radius: 5px; color:#f5f5f5; border-top-right-radius: 5px; text-align:center; height:50px; line-height:50px; font-size:18px; text-decoration:none;}
    .form-tab .tab-li.cur{ border-bottom-color:#f0ebeb;}
    .form-tab .tab-li.cur a{ color:#222;}
    .form-tab .tab-li .icon{ position:absolute; top:10px; width:18px; height:14px; margin-left:6px;}

    .form-box .form-con{ width:480px; height:258px; padding:0;}
    .form-box .weixin-login{ width:420px; padding-top:25px;}
    .login-add .form-con{ height:342px; padding-top:41px;}
    .form-box .login-normal,.form-box .login-partner{ display:none;position:relative; width:480px; padding:0 10px; margin: 0 auto;}
    ...
    .form-box .form-error i{ position:absolute; top:4px; left:12px; width:16px; height:16px;background: url('/content/images/member.png') -124px 0 no-repeat;}
    .form-box .form-error .text{display:block;max-width: 258px; padding-left:22px; line-height:16px; font-family:"Microsoft YaHei"; color:#666;/*  white-space:nowrap;background:url('/content/images/member.png') -124px 0 no-repeat; */ }
    .form-box dl{ position:relative; width:460px; height:46px; line-height:46px; padding:14px 0; border:1px solid #ddd; font-family:"Microsoft YaHei"; margin-bottom: 10px; font-size:14px;}
    ...
    .form-box dt{ float:left; text-align: right; width:110px; height:20px; line-height:20px; padding-left:20px;}
    .form-box dt em{ padding:0 7px;}
    .form-box dd{ position:relative; float:left; width:320px; height:20px; line-height:20px;}
    .form-box .placeholder{ position:absolute; height:20px; line-height:20px; left:10px; z-index:1; color:#ccc;}
    .form-box .input-text,.form-box .input-yzm,.form-box .input-jym{ position:absolute; height:20px; line-height:20px; border:0; padding:0 10px; left:0; z-index:2; background:transparent; outline:0 none; }
    .form-box .input-text{width:320px;}
    ...
    .form-box .tips em{ position:absolute; top:-1px; left:-10px; width:11px; height:10px; background:url('/content/images/member.png') 0 0 no-repeat;}
    .form-box .tips i{ display:inline-block; width:24px; height:24px; background:url('/content/images/member.png') -11px 0 no-repeat; vertical-align:top;}
    ...
    .form-box .btn-box .btn-settlement{ width:460px;}
    ...
    .form-box .login-short{ border-top:1px dotted #ddd;}
    .login-short h3{ font-size:12px; margin: 0 auto; line-height:1; padding:8px 0 13px; color:#666;}
    .login-short li{ float:left; height:33px; width:33px; margin-right:18px; background:url('/content/images/member.png') -13px -24px no-repeat;}
    ...
    .register-left .correct{ display:none; position:absolute; right:10px; top:50%; height:24px; width:24px; margin-top:-12px; background:url('/content/images/member.png') -35px 0 no-repeat;}
    ...
    /*修改提示文字的颜色*/
    nput::-webkit-input-placeholder { /* WebKit browsers */
        color: #ccc;
    }
