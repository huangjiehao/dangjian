...
<style>
    ...
    .input{ height: 31px; line-height: 31px; border:0!important; vertical-align: top; }
</style>
...
<div class="main ly_main">
    <div class="main_content">
        ...
        <div class="ly_search">
            <form id="search_mini_form" action="course_list#在线学习" class="formData" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-search">
                    ...
                    <input id="search" type="text" name="searchName" value="" placeholder="搜索..." class="input" maxlength="128" />
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <ul class="thumbnails">
                                <?php
                                if (!empty($data)) {
                                    if(!empty($data['data']['listStudyInfo'])){
                                        foreach ($data['data']['listStudyInfo'] as $data_k => $data_val) {
                                                        ...
                                                        <div class="thumbnailtrans">
                                                            <div class="thumbnail">
                                                                <a href="javascript:void(0);" >
                                                                    <img src="';if (!empty($crlmPrcUrl)) {echo html::encode($crlmPrcUrl);} else {echo '/content/images/default.png';}echo '" alt="" >
                                                                </a>
                                                            </div>
                                                            <div class="caption">
